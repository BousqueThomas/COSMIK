...
def read_mmpose_file(nom_fichier):
    ...
    with open(nom_fichier, 'r') as f:
        for ligne in f:
            ...
            donnees.append([float(valeur) for valeur in ligne[2:]])  # Convertir les valeurs en float, en excluant le num_sample et le score 
...
def get_cams_params_challenge()->dict:
    donnees = {   
        # Wanchen !!! 
        # "55555": {
        #     "mtx" : np.array([ [ 644.99917628969513, 0., 647.24417307755652,],[ 0., 642.50825716637769, 358.02333277512037,],[ 0., 0., 1., ],]),
        #     "dist" : [ -0.0014761762815576447, 0.017120682703549765, -0.0052566263650747182, 0.0062728217294230147, 0.009062778514451161, ],
        #     "rotation": [1., 0.,0., 
        #                  0., 1., 0., 
        #                  0., 0., 1.,],
        #     "translation": [0., 
        ...
        # "88888": {
        #     "dist" : [ -0.00620928185424239, 0.015830978582784577, -0.0044801024950339016, 0.00069471237287195564, -0.014278713284325558, ],
        #     "mtx": np.array([ [ 644.89157339602264, 0., 639.37402489290434,],[ 0., 647.54013695733738, 354.52644999784451,],[ 0., 0., 1., ],]),
        #     "rotation" : [ 0.89931796571074851, 0.067164809037635539,-0.43210656669023079, 
        #                   -0.068638924401493565, 0.99756692747918152,0.012203411684912506,
        #                     0.43187485989217639, 0.018684582593233402,0.90173998013087431, ],
        #     "translation" : [ 0.54509633010288117, 
        #                      -0.04676441911581021,
        #                      0.09689202913631223, ]
        # },
...
def TRC2numpy(pathFile, markers,rotation=None):
    ...
    # print('this_dat :',this_dat, len(this_dat),'data=',data)
    this_dat[:, 0] = time
